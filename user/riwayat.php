...
<head>
    ...
    <style>
        @media print {
            ...
            .bukti-card button {
                display: none; /* Menyembunyikan tombol cetak saat dicetak */
            }
        }
    </style>
</head>
...
<main class="container" style="margin-top: 20px;">
        ...
        <div class="riwayat-item card">
            ...
            <?php if ($row['status'] == 'Selesai'): ?>
                <div style="text-align: center; margin: 20px 0;">
                    <a href="?cetak=1&id=<?= $row['id'] ?>" class="button" style="text-align: center;">Cetak Bukti Pengajuan</a>
                </div>
            <?php endif; ?>
        </div>
        <?php endwhile; ?>
    ...
    <div class="card" style="margin-top: 20px; text-align: center;">
        <h2>Bukti Pengajuan Layanan</h2>
            ...
            <p><strong>Tanggal Pengajuan:</strong> <?= date('d-m-Y', strtotime($data_pengajuan['tanggal_pengajuan'])) ?></p>
